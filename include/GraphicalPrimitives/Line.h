...
private:
	...
	void DrawHorizontal888To888( uint16_t xPos, uint16_t yPos, uint16_t size );
	void DrawHorizontal322To322( uint16_t xPos, uint16_t yPos, uint16_t size );

private:
    void DrawVertical322To888( uint16_t xPos, uint16_t yPos, uint16_t size );
	void DrawVertical888To888( uint16_t xPos, uint16_t yPos, uint16_t size );
