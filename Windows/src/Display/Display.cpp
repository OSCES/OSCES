...
{ 
    ...
    WindowResize( m_SurfaceSizeX, m_SurfaceSizeY );   
}
...
void Display_t::WindowResize( uint16_t xSize, uint16_t ySize )
{
    ...
    if( 0 == m_pWindow )
    {
        m_pWindow = SDL_CreateWindow("My Game Window", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, m_WindowSizeX, m_WindowSizeY,
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, m_SurfaceSizeX, m_SurfaceSizeY, 0, GL_RGB, GL_UNSIGNED_BYTE, 0);
