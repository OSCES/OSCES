...
uint8_t* Fsmc_t::GetAddressBank2( void )
{
    return ( uint8_t* )BANK1_SRAM2_ADDR;
}

uint8_t* Fsmc_t::GetAddressBank3( void )
{
    return ( uint8_t* )BANK1_SRAM3_ADDR;
}

uint8_t *Fsmc_t::GetAddressBank4( void )
{
    return ( uint8_t* )BANK1_SRAM4_ADDR;
}
...
void Fsmc_t::FsmcInit( void )
{
    ...
    FSMC_NORSRAMTimingStructure.FSMC_DataSetupTime         = 4;
    FSMC_NORSRAMTimingStructure.FSMC_BusTurnAroundDuration = 1;
