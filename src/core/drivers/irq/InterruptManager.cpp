...
#define CALL_VECTOR(vector) \
    m_intRoutineTable[vector](m_contextTable[vector])
...
void InterruptManager::ResetHandler()
{
    ...
    __iar_program_start();
#else
    // TODO: setup simulator reset handler
#endif
}
...
__root const InterruptManager::HandlerItem InterruptManager::m_interruptVectorTable[] =
{
